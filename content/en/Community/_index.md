...
Kyverno was accepted to CNCF on November 10, 2020 and is at the incubating project maturity level.

The goal of this adopters program is to gather real-world usage examples and help Kyverno achieve the graduation level criteria. We hope to achieve this by learning from the existing and new adopters of Kyverno who are willing to share their stories with CNCF. The adopters can remain private or choose to be listed in the public [Adopters List](https://github.com/kyverno/kyverno/blob/main/ADOPTERS.md).
